...
export class EngagementUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    id: [],
    scoring: [null, [Validators.required, Validators.min(0)]],
  ...
  updateForm(engagement: IEngagement): void {
    this.editForm.patchValue({
      ...
      startDate: engagement.startDate ? engagement.startDate.format(DATE_TIME_FORMAT) : null,
      enDate: engagement.enDate ? engagement.enDate.format(DATE_TIME_FORMAT) : null,
  ...
  private createFromForm(): IEngagement {
    return {
      ...
      enDate: this.editForm.get(['enDate'])!.value ? moment(this.editForm.get(['enDate'])!.value, DATE_TIME_FORMAT) : undefined,
