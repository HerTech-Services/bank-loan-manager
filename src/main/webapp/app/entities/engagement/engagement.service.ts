...
export class EngagementService {
  ...
  protected convertDateFromClient(engagement: IEngagement): IEngagement {
    const copy: IEngagement = Object.assign({}, engagement, {
      startDate: engagement.startDate && engagement.startDate.isValid() ? engagement.startDate.toJSON() : undefined,
      enDate: engagement.enDate && engagement.enDate.isValid() ? engagement.enDate.toJSON() : undefined,
