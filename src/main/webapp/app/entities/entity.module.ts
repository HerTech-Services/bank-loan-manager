...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'history',
        loadChildren: () => import('./history/history.module').then(m => m.BankLoanManagerHistoryModule),
      },
      {
        path: 'poste',
        loadChildren: () => import('./poste/poste.module').then(m => m.BankLoanManagerPosteModule),
      },
      {
        path: 'user-poste',
        loadChildren: () => import('./user-poste/user-poste.module').then(m => m.BankLoanManagerUserPosteModule),
      },
      {
        path: 'notes',
