...
export class NotesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.notesService
      ...
      .subscribe(
        (res: HttpResponse<INotes[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNotes(): void {
    this.eventSubscriber = this.eventManager.subscribe('notesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INotes[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
