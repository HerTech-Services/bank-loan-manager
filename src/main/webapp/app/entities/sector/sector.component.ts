...
export class SectorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.sectorService
      ...
      .subscribe(
        (res: HttpResponse<ISector[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSectors(): void {
    this.eventSubscriber = this.eventManager.subscribe('sectorListModification', () => this.loadPage());
  }
