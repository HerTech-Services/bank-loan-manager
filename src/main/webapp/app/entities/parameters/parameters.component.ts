...
export class ParametersComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.parametersService
      ...
      .subscribe(
        (res: HttpResponse<IParameters[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInParameters(): void {
    this.eventSubscriber = this.eventManager.subscribe('parametersListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IParameters[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
