...
type SelectableEntity = ITaskType | IUser | IPoste | IEngagement;
...
export class TaskUpdateComponent implements OnInit {
  ...
  updateForm(task: ITask): void {
    this.editForm.patchValue({
      ...
      typeId: task.typeId,
      processUserId: task.processUserId,
      posteId: task.posteId,
  ...
  private createFromForm(): ITask {
    return {
      ...
      processUserId: this.editForm.get(['processUserId'])!.value,
