...
public class RejectResource {
    ...
    public RejectResource(RejectService rejectService) {
     ...
     */
    @GetMapping("/rejects")
    public ResponseEntity<List<RejectDTO>> getAllRejects(Pageable pageable) {
        log.debug("REST request to get a page of Rejects");
        Page<RejectDTO> page = rejectService.findAll(pageable);
