...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tect.her.ccm.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tect.her.ccm.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, tect.her.ccm.domain.History.class.getName());
            createCache(cm, tect.her.ccm.domain.Poste.class.getName());
            createCache(cm, tect.her.ccm.domain.Poste.class.getName() + ".userPostes");
            createCache(cm, tect.her.ccm.domain.Poste.class.getName() + ".parentPostes");
            createCache(cm, tect.her.ccm.domain.Poste.class.getName() + ".children");
            createCache(cm, tect.her.ccm.domain.UserPoste.class.getName());
