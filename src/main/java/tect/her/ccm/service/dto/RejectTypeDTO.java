...
/**
 * A DTO for the {@link tect.her.ccm.domain.RejectType} entity.
 */
public class RejectTypeDTO implements Serializable {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RejectTypeDTO)) {
            return false;
        }

        return id != null && id.equals(((RejectTypeDTO) o).id);
    }
