...
public class EngagementCriteria implements Serializable, Criteria {
    ...
    public IntegerFilter getScoring() {
        return scoring;
    }

    public void setScoring(IntegerFilter scoring) {
    ...
    public InstantFilter getEnDate() {
        return enDate;
    }

    public void setEnDate(InstantFilter enDate) {
        this.enDate = enDate;
    }
