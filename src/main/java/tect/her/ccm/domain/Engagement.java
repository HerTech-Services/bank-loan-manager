...
public class Engagement implements Serializable {
    ...
    public Engagement identifier(String identifier) {
    ...
    public Engagement scoring(String scoring) {
    ...
    public Engagement enDate(LocalDate enDate) {
        this.enDate = enDate;
        return this;
    }
    ...
    public Engagement submissionDate(LocalDate submissionDate) {
