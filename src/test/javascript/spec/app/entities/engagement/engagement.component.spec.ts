...
import { EngagementComponent } from 'app/entities/engagement/engagement.component';
...
describe('Component Tests', () => {
  describe('Engagement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.engagements && comp.engagements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
