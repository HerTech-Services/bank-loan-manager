...
import { EngagementTypeComponent } from 'app/entities/engagement-type/engagement-type.component';
...
describe('Component Tests', () => {
  describe('EngagementType Management Component', () => {
    let comp: EngagementTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EngagementTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.engagementTypes && comp.engagementTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
