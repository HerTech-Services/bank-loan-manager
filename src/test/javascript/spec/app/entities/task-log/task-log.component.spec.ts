...
import { TaskLogComponent } from 'app/entities/task-log/task-log.component';
...
describe('Component Tests', () => {
  describe('TaskLog Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskLogs && comp.taskLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
