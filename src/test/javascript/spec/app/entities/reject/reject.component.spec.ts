...
import { RejectComponent } from 'app/entities/reject/reject.component';
import { RejectService } from 'app/entities/reject/reject.service';
import { Reject } from 'app/shared/model/reject.model';

describe('Component Tests', () => {
  describe('Reject Management Component', () => {
    let comp: RejectComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RejectComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rejects && comp.rejects[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
