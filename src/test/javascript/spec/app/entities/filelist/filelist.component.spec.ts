...
import { FilelistComponent } from 'app/entities/filelist/filelist.component';
...
describe('Component Tests', () => {
  describe('Filelist Management Component', () => {
    let comp: FilelistComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FilelistComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.filelists && comp.filelists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
