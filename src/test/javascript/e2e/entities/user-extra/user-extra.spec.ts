...
describe('UserExtra e2e test', () => {
  ...
  it('should load UserExtras', async () => {
    ...
    expect(await userExtraComponentsPage.getTitle()).to.eq('bankLoanManagerApp.userExtra.home.title');
  ...
  it('should load create UserExtra page', async () => {
    ...
    expect(await userExtraUpdatePage.getPageTitle()).to.eq('bankLoanManagerApp.userExtra.home.createOrEditLabel');
  ...
  /* it('should create and save UserExtras', async () => {
        ...
        await promise.all([
            ...
            userExtraUpdatePage.setPreferencesInput('preferences'),
        ...
        expect(await userExtraUpdatePage.getPreferencesInput()).to.eq('preferences', 'Expected Preferences value to be equals to preferences');
  ...
  /* it('should delete last UserExtra', async () => {
        ...
        expect(await userExtraDeleteDialog.getDialogTitle())
            .to.eq('bankLoanManagerApp.userExtra.delete.question');
