...
describe('Parameters e2e test', () => {
  ...
  it('should create and save Parameters', async () => {
    ...
    await promise.all([
      ...
      parametersUpdatePage.setParamValueJsonInput('paramValueJson'),
    ...
    expect(await parametersUpdatePage.getParamValueJsonInput()).to.eq(
      'paramValueJson',
      'Expected ParamValueJson value to be equals to paramValueJson'
    );
