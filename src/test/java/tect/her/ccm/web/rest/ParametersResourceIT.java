...
public class ParametersResourceIT {
    ...
    private static final String DEFAULT_PARAM_VALUE_JSON = "AAAAAAAAAA";
    private static final String UPDATED_PARAM_VALUE_JSON = "BBBBBBBBBB";
    ...
    public static Parameters createEntity(EntityManager em) {
        Parameters parameters = new Parameters()
            ...
            .paramValueJson(DEFAULT_PARAM_VALUE_JSON)
    ...
    public static Parameters createUpdatedEntity(EntityManager em) {
        Parameters parameters = new Parameters()
            ...
            .paramValueJson(UPDATED_PARAM_VALUE_JSON)
    ...
    public void createParameters() throws Exception {
        ...
        assertThat(testParameters.getParamValueJson()).isEqualTo(DEFAULT_PARAM_VALUE_JSON);
    ...
    public void getAllParameters() throws Exception {
        ...
        restParametersMockMvc
            ...
            .andExpect(jsonPath("$.[*].paramValueJson").value(hasItem(DEFAULT_PARAM_VALUE_JSON.toString())))
    ...
    public void getParameters() throws Exception {
        ...
        restParametersMockMvc
            ...
            .andExpect(jsonPath("$.paramValueJson").value(DEFAULT_PARAM_VALUE_JSON.toString()))
    ...
    public void updateParameters() throws Exception {
        ...
        assertThat(testParameters.getParamValueJson()).isEqualTo(UPDATED_PARAM_VALUE_JSON);
