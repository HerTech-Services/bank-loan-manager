...
public class EngagementResourceIT {
    ...
    private static final String DEFAULT_SCORING = "AAAAAAAAAA";
    private static final String UPDATED_SCORING = "BBBBBBBBBB";
    ...
    private static final LocalDate DEFAULT_EN_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EN_DATE = LocalDate.now(ZoneId.systemDefault());
    private static final LocalDate SMALLER_EN_DATE = LocalDate.ofEpochDay(-1L);
    ...
    private static final LocalDate SMALLER_SUBMISSION_DATE = LocalDate.ofEpochDay(-1L);
    ...
    public void createEngagement() throws Exception {
        ...
        assertThat(testEngagement.getIdentifier()).isEqualTo(DEFAULT_IDENTIFIER);
        ...
        assertThat(testEngagement.getSubmissionDate()).isEqualTo(DEFAULT_SUBMISSION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllEngagementsByIdentifierIsEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier equals to DEFAULT_IDENTIFIER
        defaultEngagementShouldBeFound("identifier.equals=" + DEFAULT_IDENTIFIER);

        // Get all the engagementList where identifier equals to UPDATED_IDENTIFIER
        defaultEngagementShouldNotBeFound("identifier.equals=" + UPDATED_IDENTIFIER);
    }

    @Test
    @Transactional
    public void getAllEngagementsByIdentifierIsNotEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier not equals to DEFAULT_IDENTIFIER
        defaultEngagementShouldNotBeFound("identifier.notEquals=" + DEFAULT_IDENTIFIER);

        // Get all the engagementList where identifier not equals to UPDATED_IDENTIFIER
        defaultEngagementShouldBeFound("identifier.notEquals=" + UPDATED_IDENTIFIER);
    }

    @Test
    @Transactional
    public void getAllEngagementsByIdentifierIsInShouldWork() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier in DEFAULT_IDENTIFIER or UPDATED_IDENTIFIER
        defaultEngagementShouldBeFound("identifier.in=" + DEFAULT_IDENTIFIER + "," + UPDATED_IDENTIFIER);

        // Get all the engagementList where identifier equals to UPDATED_IDENTIFIER
        defaultEngagementShouldNotBeFound("identifier.in=" + UPDATED_IDENTIFIER);
    }

    @Test
    @Transactional
    public void getAllEngagementsByIdentifierIsNullOrNotNull() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier is not null
        defaultEngagementShouldBeFound("identifier.specified=true");

        // Get all the engagementList where identifier is null
        defaultEngagementShouldNotBeFound("identifier.specified=false");
    }

    @Test
    @Transactional
    public void getAllEngagementsByIdentifierContainsSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier contains DEFAULT_IDENTIFIER
        defaultEngagementShouldBeFound("identifier.contains=" + DEFAULT_IDENTIFIER);

        // Get all the engagementList where identifier contains UPDATED_IDENTIFIER
        defaultEngagementShouldNotBeFound("identifier.contains=" + UPDATED_IDENTIFIER);
    }

    @Test
    @Transactional
    public void getAllEngagementsByIdentifierNotContainsSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where identifier does not contain DEFAULT_IDENTIFIER
        defaultEngagementShouldNotBeFound("identifier.doesNotContain=" + DEFAULT_IDENTIFIER);

        // Get all the engagementList where identifier does not contain UPDATED_IDENTIFIER
        defaultEngagementShouldBeFound("identifier.doesNotContain=" + UPDATED_IDENTIFIER);
    }
    ...
    @Test
    @Transactional
    public void getAllEngagementsByScoringContainsSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where scoring contains DEFAULT_SCORING
        defaultEngagementShouldBeFound("scoring.contains=" + DEFAULT_SCORING);

        // Get all the engagementList where scoring contains UPDATED_SCORING
        defaultEngagementShouldNotBeFound("scoring.contains=" + UPDATED_SCORING);
    }

    @Test
    @Transactional
    public void getAllEngagementsByScoringNotContainsSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where scoring does not contain DEFAULT_SCORING
        defaultEngagementShouldNotBeFound("scoring.doesNotContain=" + DEFAULT_SCORING);

        // Get all the engagementList where scoring does not contain UPDATED_SCORING
        defaultEngagementShouldBeFound("scoring.doesNotContain=" + UPDATED_SCORING);
    }
    ...
    @Test
    @Transactional
    public void getAllEngagementsByStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where startDate is greater than or equal to DEFAULT_START_DATE
        defaultEngagementShouldBeFound("startDate.greaterThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the engagementList where startDate is greater than or equal to UPDATED_START_DATE
        defaultEngagementShouldNotBeFound("startDate.greaterThanOrEqual=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where startDate is less than or equal to DEFAULT_START_DATE
        defaultEngagementShouldBeFound("startDate.lessThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the engagementList where startDate is less than or equal to SMALLER_START_DATE
        defaultEngagementShouldNotBeFound("startDate.lessThanOrEqual=" + SMALLER_START_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByStartDateIsLessThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where startDate is less than DEFAULT_START_DATE
        defaultEngagementShouldNotBeFound("startDate.lessThan=" + DEFAULT_START_DATE);

        // Get all the engagementList where startDate is less than UPDATED_START_DATE
        defaultEngagementShouldBeFound("startDate.lessThan=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where startDate is greater than DEFAULT_START_DATE
        defaultEngagementShouldNotBeFound("startDate.greaterThan=" + DEFAULT_START_DATE);

        // Get all the engagementList where startDate is greater than SMALLER_START_DATE
        defaultEngagementShouldBeFound("startDate.greaterThan=" + SMALLER_START_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllEngagementsByEnDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where enDate is greater than or equal to DEFAULT_EN_DATE
        defaultEngagementShouldBeFound("enDate.greaterThanOrEqual=" + DEFAULT_EN_DATE);

        // Get all the engagementList where enDate is greater than or equal to UPDATED_EN_DATE
        defaultEngagementShouldNotBeFound("enDate.greaterThanOrEqual=" + UPDATED_EN_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByEnDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where enDate is less than or equal to DEFAULT_EN_DATE
        defaultEngagementShouldBeFound("enDate.lessThanOrEqual=" + DEFAULT_EN_DATE);

        // Get all the engagementList where enDate is less than or equal to SMALLER_EN_DATE
        defaultEngagementShouldNotBeFound("enDate.lessThanOrEqual=" + SMALLER_EN_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByEnDateIsLessThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where enDate is less than DEFAULT_EN_DATE
        defaultEngagementShouldNotBeFound("enDate.lessThan=" + DEFAULT_EN_DATE);

        // Get all the engagementList where enDate is less than UPDATED_EN_DATE
        defaultEngagementShouldBeFound("enDate.lessThan=" + UPDATED_EN_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsByEnDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where enDate is greater than DEFAULT_EN_DATE
        defaultEngagementShouldNotBeFound("enDate.greaterThan=" + DEFAULT_EN_DATE);

        // Get all the engagementList where enDate is greater than SMALLER_EN_DATE
        defaultEngagementShouldBeFound("enDate.greaterThan=" + SMALLER_EN_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate equals to DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.equals=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate equals to UPDATED_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.equals=" + UPDATED_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate not equals to DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.notEquals=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate not equals to UPDATED_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.notEquals=" + UPDATED_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsInShouldWork() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate in DEFAULT_SUBMISSION_DATE or UPDATED_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.in=" + DEFAULT_SUBMISSION_DATE + "," + UPDATED_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate equals to UPDATED_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.in=" + UPDATED_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate is not null
        defaultEngagementShouldBeFound("submissionDate.specified=true");

        // Get all the engagementList where submissionDate is null
        defaultEngagementShouldNotBeFound("submissionDate.specified=false");
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate is greater than or equal to DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.greaterThanOrEqual=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate is greater than or equal to UPDATED_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.greaterThanOrEqual=" + UPDATED_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate is less than or equal to DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.lessThanOrEqual=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate is less than or equal to SMALLER_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.lessThanOrEqual=" + SMALLER_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsLessThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate is less than DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.lessThan=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate is less than UPDATED_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.lessThan=" + UPDATED_SUBMISSION_DATE);
    }

    @Test
    @Transactional
    public void getAllEngagementsBySubmissionDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        engagementRepository.saveAndFlush(engagement);

        // Get all the engagementList where submissionDate is greater than DEFAULT_SUBMISSION_DATE
        defaultEngagementShouldNotBeFound("submissionDate.greaterThan=" + DEFAULT_SUBMISSION_DATE);

        // Get all the engagementList where submissionDate is greater than SMALLER_SUBMISSION_DATE
        defaultEngagementShouldBeFound("submissionDate.greaterThan=" + SMALLER_SUBMISSION_DATE);
    }
    ...
    public void updateEngagement() throws Exception {
        ...
        Engagement testEngagement = engagementList.get(engagementList.size() - 1);
        assertThat(testEngagement.getIdentifier()).isEqualTo(UPDATED_IDENTIFIER);
        ...
        assertThat(testEngagement.getSubmissionDate()).isEqualTo(UPDATED_SUBMISSION_DATE);
    }
