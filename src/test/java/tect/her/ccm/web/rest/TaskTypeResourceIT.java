...
public class TaskTypeResourceIT {
    ...
    public void createTaskType() throws Exception {
        ...
        assertThat(testTaskType.getDelay()).isEqualTo(DEFAULT_DELAY);
    ...
    public void updateTaskType() throws Exception {
        ...
        updatedTaskType.label(UPDATED_LABEL).identifier(UPDATED_IDENTIFIER).delay(UPDATED_DELAY).isEnabled(UPDATED_IS_ENABLED);
        ...
        assertThat(testTaskType.getDelay()).isEqualTo(UPDATED_DELAY);
